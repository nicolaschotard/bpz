...
# print t,
            ...
            if nobox:
                zorder = 10
            plot(xinxrange.tolist(), yinxrange.tolist(),
            ...
            indict = os.path.join(
                os.environ['BPZPATH'], 'plots/filtnicktex.dict')
            ...
            for i in range(len(filters)):
                ...
                if observed[i]:  # OBSERVED
                    ...
                    plot([lambda_m[i]], [0], 'o', markerfacecolor='w',
                         markeredgecolor=color, markersize=ms)
